    ...
    <q-card style="width: 390px" class="q-pa-md q-mt-lg br-10 text-light-black">
      ...
      <q-card-section class="q-px-sm">
        <q-form @submit="onSubmit" greedy>
          <q-input label="Contraseña" type="password" v-model="form.password" :rules="(val) => (val && val.length > 0) || 'Este campo es requerido.'
          ...
          <q-input label="Confirmar contraseña" type="password" v-model="form.confirmPassword" :rules="(val) =>
